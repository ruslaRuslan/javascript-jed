...
// let arr = ['test', 'sada', 'ali', 'shahmurad', 'ali', 'intiqam']
// arr.splice(0, 2, 'Ruslan')
// console.log(arr); //ikisini silir Ruslani elave dece
...
// let arr = ['test', 'sada', 'ali', 'shahmurad', 'ali', 'intiqam']
// arr.splice(0, arr.length, 26,30,950)
// console.log(arr); //[26,30,950]
